      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="max-w-xl mx-auto text-center">
          <h2 className="text-4xl lg:text-5xl font-bold mb-6">
            <span className="text-accent">Visita</span>{" "}
            <span className="text-primary">Nuestro Reino</span>
          </h2>
          <p className="text-lg text-muted-foreground mb-12">
            Ven y descubre un mundo de sabores únicos donde la magia y el sabor
            se encuentran.
          </p>
            ...
            <div className="flex items-center gap-4 text-left">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Calle Principal #123, Centro de la Ciudad
                </p>
              </div>
            </div>
          ...
          <div className="flex justify-center flex-wrap gap-4">
            ...
            {/* Instagram */}
            <Button size="icon" className="w-12 h-12 bg-accent hover:bg-accent/90 text-accent-foreground rounded-full">
